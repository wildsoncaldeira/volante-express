                ...
                <main className="flex-1 overflow-y-auto p-4 md:p-8 pb-24 md:pb-8 bg-gray-100">
                    {loading ? <div className="h-full flex items-center justify-center text-slate-400">Carregando dados...</div> : (
                        <div className="max-w-7xl mx-auto animate-in fade-in space-y-6">
                            ...
                            {activeTab === 'equipe' && (
                                <motion.div key="equipe" initial="hidden" animate="show" exit="exit" variants={{ hidden: { opacity: 0, y: 10 }, show: { opacity: 1, y: 0, transition: { duration: 0.2, staggerChildren: 0.1 } }, exit: { opacity: 0, y: -10, transition: { duration: 0.2 } } }} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                            ...
                            {activeTab === 'estoque' && (
                                <motion.div key="estoque" initial="hidden" animate="show" exit="exit" variants={{ hidden: { opacity: 0, y: 10 }, show: { opacity: 1, y: 0, transition: { duration: 0.2, staggerChildren: 0.08 } }, exit: { opacity: 0, y: -10, transition: { duration: 0.2 } } }} className="space-y-6">
