...
function HomeContent() {
  ...
  if (loading) return <div className="min-h-screen bg-slate-950 flex items-center justify-center text-white"><img src="/3dgifmaker87764.gif" alt="Carregando..." className="w-48 h-48 object-contain" /></div>;
...
export default function HomePage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-slate-950 flex items-center justify-center text-white"><img src="/3dgifmaker87764.gif" alt="Carregando..." className="w-48 h-48 object-contain" /></div>}>
      <HomeContent />
    </Suspense>
  );
}